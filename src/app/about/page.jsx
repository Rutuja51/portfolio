        ...
        <>
            <main className="about-page">
                <div className="about-section">
                    ...
                    <h2 className="text-4xl my-16">What I do ?</h2>
                    <ul className="text-2xl flex flex-col gap-8">
                        <li>- Responsive User Interface Development</li>
                        <li>- Dynamic Data Binding & State Management</li>
                        <li>- API Development & Integration</li>
                        <li>- RESTful API Development</li>
                        <li>- Docker Containerization</li>
                        <li>- CI/CD Pipeline Implementation</li>
                        <li>- Application Hosting & Deployment</li>
                    </ul>
                </div>
            </main>
        </>
